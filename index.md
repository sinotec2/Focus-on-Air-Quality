...
[What's New](https://sinotec2.github.io/jtd/docs/EmisProc/ptse/pt2em_d04/){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 } [Leave messages on GitHub](https://github.com/sinotec2/jtd/discussions/){: .btn .fs-5 .mb-4 .mb-md-0 }

---

## What's New
- 2021-12-08 整體TEDS系統最複雜(也最真實)的部分應該算是點源了，程式撰寫也花最多的篇幅。點源結束在[pt2em_d04](https://sinotec2.github.io/jtd/docs/EmisProc/ptse/pt2em_d04/)這支轉檔程式，可以用來檢查高空點源的位置、時間變化是否正確。也可以參考[nbviewer](https://nbviewer.org/github/sinotec2/jtd/blob/main/docs/EmisProc/ptse/pt2em_d04.ipynb)
