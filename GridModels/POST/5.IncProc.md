...
| ![圖1a-N3G_NO3.png](../../assets/images/N3G_NO3.png){:width="360px"} |![圖1b-N3G_NO3.png](../../assets/images/N3G_NO3T.png){:width="360px"}
|:--:|:--:|
| <b>圖1a 2019/01/01/00Z 興達新3氣機組PM<sub>2.5</sub>中NO<sub>3</sub><sup>-</sup>濃度值之增量。</b>|<b>圖1b 同左但為月平均值</b>|
| ![圖2a-PM25ACdiffT.png](../../assets/images/PM25ACdiffT.png){:width="360px"} |![圖2b-PM10ACdiffT.png](../../assets/images/PM10ACdiffT.png){:width="360px"} |
...
| ![圖3a-N3GPMdiff.png](../../assets/images/N3GPMdiff.png){:width="360px"} |![圖3b-N3GPMdiffT.png](../../assets/images/N3GPMdiffT.png){:width="360px"} |
...
| ![圖4a-N3G_PM25.png.png](../../assets/images/N3G_PM25.png){:width="360px"} |![圖4b-cctm.XindaN3G-BASE.nc_Filtered_PM25.png](../../assets/images/cctm.XindaN3G-BASE.nc_Filtered_PM25.png){:width="360px"}
|:--:|:--:|
| <b>圖4a 2019年1月份平均PM<sub>2.5</sub>增量濃度 </b>|<b>圖4b 同左但為新計算程序</b>|
| ![圖5a-N3G_PM10.png](../../assets/images/N3G_PM10.png){:width="360px"} |![圖5b-cctm.XindaN3G-BASE.nc_Filtered_PM10.png](../../assets/images/cctm.XindaN3G-BASE.nc_Filtered_PM10.png){:width="360px"}|
| <b>圖5a 2019年1月份平均PM<sub>10</sub>增量濃度 </b>|<b>圖5b 同左但為新計算程序</b>|
| ![圖6a-N3G_rat.png](../../assets/images/N3G_rat.png){:width="360px"} |![圖6b-cctm.XindaN3G-BASE.nc_Filtered_rat.png](../../assets/images/cctm.XindaN3G-BASE.nc_Filtered_rat.png){:width="360px"}|
