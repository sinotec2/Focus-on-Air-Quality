#cat /Users/Data/cwb/e-service/btraj_WRFnests/ftuv10_5dN.py
...
def openNC(sdate):
  uvPath='/Users/Data/cwb/e-service/btraj_WRFnests/CWB_forecast/U10V10_d0'
  ...
  if M==3:
    fnames=[uvPath+str(i)+'_'+ymd+uvTail for i in range(1,M+1)]
  elif M==2:
