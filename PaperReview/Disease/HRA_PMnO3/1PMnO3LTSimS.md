...
### 模擬結果檢討
依照空氣品質規範要求檢討wrf 2019年模擬結果如表1所示，各月份測站的符合度除8/11~12月之風速外，皆可達72%以上，能符合規範60%以上要求。
...
- 本評估工作採環保署公開之TEDS 11資料庫，包括其排放時間變化、業別等設定，輸入排放模式進行數據檔案之準備。
### 東亞地區之污染排放
...
#### 表2 	2019年網格模式模擬台灣地區測站模式性能之符合度，單位：%
...
- O3:非配對峰值常化偏差(Maximum peak normalized Bias, MB)
- O3,NO2,NMHC,SO2
...
### 空間分布
- 2019年臺灣各鄉鎮區PM2.5之平均值，單位&mu;g/m<sup>3</sup>
...
|:--:|:--:|
| <b>環保署測值</b>|<b>CAM-chem模擬結果經校正調整後的歷年平均值</b>|
...
|:--:|:--:|
|<b>PM2.5(&mu;g/m<sup>3</sup>)</b>|<b>O3(ppb)</b>|
