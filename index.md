...
- 2023-06-17 這半年來似乎乏善可陳，主要卡在[預報系統](./ForecastSystem/11fcst.md)的枝微細節，晚上斷電的問題、國網的調適問題、畫面輸出與使用者介面等等，方案定不下來，重複卻少許變動的筆記越寫越多，也不敢說什麼才是真正新的、值得分享的。或許發展系統最終的結局就是等著被替代更新吧！
