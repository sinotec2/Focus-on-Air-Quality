...
## What's New
- 2022-04-19 疫情來了，有網友把每天公告的數據用leaflet寫了網頁公開在github.io。這引起我的興趣，也把一些靜態(廣播)網頁陸續搬到[https://sinotec2.github.io/](https://sinotec2.github.io/)，實則也想關閉httpd一下，好好找個防止駭客攻擊的方法（基本上[這題](https://sinotec2.github.io/Focus-on-Air-Quality/utilities/OperationSystem/自動添加並啟用IP黑名單)應該算是完成了）。
