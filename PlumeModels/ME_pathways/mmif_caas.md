...
- 降雨量：
	- 降雨量是HRA評估必須要有的項目
	- 一般wrfout有降雨量，但在CWB_WRF須注意另外讀取([rd_grbCubicA.py](https://sinotec2.github.io/Focus-on-Air-Quality/wind_models/cwbWRF_3Km/rd_grbCubicA/#rd_grbcubicapy分段說明)、[fil_grb_nc.py](https://sinotec2.github.io/Focus-on-Air-Quality/wind_models/cwbWRF_3Km/fil_grb_nc/))。
