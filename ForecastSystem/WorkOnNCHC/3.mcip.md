...
- MCIP的[編譯](../../GridModels/MCIP/1.make_mcip.md)與[執行](../../GridModels/MCIP/3.run_mcipMM_RR_DM.md)、[修正](../../GridModels/MCIP/4.add_firstHr.md)等，可以參考[CMAQ模式的氣象檔案之準備](../../GridModels/MCIP/mcip.md)
- m
