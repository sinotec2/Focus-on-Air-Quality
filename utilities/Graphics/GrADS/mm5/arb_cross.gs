...
*'set vrange 10 'height
*'set yaxis 0 'hgt' 0.5'
'd coll2gr(2);coll2gr(4)*50'
**height/1.75'
'set strsiz 0.18'
'draw xlab lon(deg E)'
'draw ylab z(bar)'
'set gxout stream'
'd coll2gr(2);coll2gr(4)*50;mag(coll2gr(2),coll2gr(4)*50)'
* TERRAIN
'set lev  10 '
...
'set strsiz 0.17'
'set string 1 c 5'
'draw string 5.1 8 Pot.Temp.(K), H. Windspeed(m/s) at 'rec1' 'dat1''
'print'
*'disable print'
*'!sleep 1'
*'!gxgif -r -x 740 -y 582 -i tmp1.out -o cross_HWind_'rec1''dat1'.gif'
'printim cross_HWind_'rec1''dat1'.gif x740 y582 white'
pull dummy
step=step+3
endwhile
