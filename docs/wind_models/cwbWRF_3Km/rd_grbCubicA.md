...
- 由`grb2`轉到`wrfout_d04`的空間內插問題，詳見[WRF_3Km空間內插](https://sinotec2.github.io/jtd/docs/wind_models/cwbWRF_3Km/gen_D4bin/)說明。
...
### 空間內插
- 空間內插，並儲存在全時間變數陣列中
  - 因2個檔案的解析度一樣，簡單的線性內插即可，然因原點與投影略有差異，還是有內插模式，詳見[WRF_3Km空間內插](https://sinotec2.github.io/jtd/docs/wind_models/cwbWRF_3Km/gen_D4bin/)說明。
