...
```
### 排放檔案之切割
- 排放量之處理可以詳參[逐日模擬排放檔案之切割程式](https://sinotec2.github.io/FAQ/2022/10/13/mk_emis.html)
...
```
- 為準備下層[邊界濃度逐日處理](https://sinotec2.github.io/FAQ/2022/08/27/1dayBCON.html)，先產生逐日bcon檔案名稱序列。
...
[fcst.cs]: <https://github.com/sinotec2/Focus-on-Air-Quality/blob/main/GridModels/ForecastSystem/fcstcs.txt>