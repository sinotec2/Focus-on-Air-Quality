...
- 由於EARR[^1]數據檔案是按小時切割，因此檔案格式繁多，如果一一轉檔將會造成檔案管理上的困難。
...
{% include download.html content="[EARR2csv](https://github.com/sinotec2/Focus-on-Air-Quality/blob/main/wind_models/EARR/EARR2csv.py)" %}
