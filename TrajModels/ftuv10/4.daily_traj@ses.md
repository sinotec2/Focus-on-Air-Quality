...
|[ftuv10_5dN.py][ftuv10]|`uvPath='/Users/Data/cwb...`|`uvPath='/nas2/backup/data/NOAA/NCEP/GFS/YYYY/tw_CWBWRF_45k/U10V10_d0'`|地面風檔案路徑
|-|`path='/Users/Data/cwb...`|`path='/nas1/backup/data/cwb/e-service/surf_trj/'`|軌跡程式路徑
|-|`os.system('/opt/local/bin/csv2kml.py...`|`os.system('/usr/kbin/csv2kml.py...`|程式位置
|-|`os.system('/opt/local/bin/csv2bln.cs...`|`os.system('/usr/kbin/csv2bln.cs...`|程式位置
|[daily_trajSt.cs][daily_trajSt.cs]|...|新增根目錄WEB|主要核心作業。需讓root及apache都能讀且執行
|[csv_to_geojson][cj]| 0.0.1| 0.0.1|需重新安裝(pip)
|addVI.py|`#!/opt/anaconda3/bin/python`|`#!/opt/miniconda3/envs/py37/bin/python`|python版本及位置
|-|`path='/Users/Data...'`|`path='/nas2/backup/data/NOAA/NCEP/GFS/YYYY/TWEPA_3k/'`|行星邊界層檔案位置
|-|`os.system('/opt/anaconda3...`|`os.system('/opt/miniconda3/envs/py37/bin/csv_to_geojson '+fnameO)`|csv_to_geojson需重新安裝(pip)
|[taiMarbleScale][ncl1]|`a = addfile("/Users/...`|`a = addfile("/nas1/WRF4.0/WPS/geo_em/geo_em.d04_333m.nc","r")`|檔案來源路徑
|-|`filename="/Library/WebServer/Documents/...`|`filename="/var/www/html/taiwan/TWN_COUNTY.shp"`|-
|git|發佈到sinotec2.github.io.git|(不執行)|夜間(17:30以後)防火牆開啟無法更新
...
[ncl1]: ../../utilities/Graphics/NCL/taiMarbleScale.md "軌跡線貼在Marble底圖上"
...
[cj]: ./daily_traj_cs.md#執行csv_to_geojson "執行csv_to_geojson"
