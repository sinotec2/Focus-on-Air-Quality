...
- 有關網格系統的考量
  - 範圍類似[大氣污染情報網站](https://pm25.jp/)或[REAS](../../Global_Regional_Emission/REAS/rd_REASptsrce.md)，具有可比較性。
  - 解析度(15km)較其他地區模擬為高。  
...
## WRF之模擬
- 詳細說明如[WRF-chem](../../wind_models/WRF-chem/WRF-chem.md)
...
- [source code](https://github.com/sinotec2/cmaq_relatives/blob/master/post/pm10.ncl)
