...
1. [運用GFS/CWB/CAMS數值預報數進行台灣地區CMAQ模擬](5daysVersion/1.CMAQ_fcst.md)
...
- 排放量之處理可以詳參[逐日模擬排放檔案之切割程式](5daysVersion/3.mk_em.md)
- 台灣本島範圍的點源另外建檔處理。須執行[mk_ptse.py](5daysVersion/3.mk_em.md#d03點源的處理)
