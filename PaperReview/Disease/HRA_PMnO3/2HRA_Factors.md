...
$$
\begin{align*}
& 粗發生率 = \sum_{i=1}^{5} {\frac {N_i} {P_i}} \\
        
& 標準化發生率 = \sum_{i=1}^{5} {\frac {N_i} {P_i}} \times {\frac {Pop_i} {Pop_{total}}} \\
\\
& N_i︰單一分組的病人數 \\
& P_i︰單一分組人口數 \\
& Pop_i︰全國單一分組人口數 \\
...
[黎友苓 (2021)][130] 追蹤台北市居民世代與環保署監測值的關係，結果顯示O<sub>3</sub>每增加一個IQR (3.028 ppb)其糖尿病前期的罹病勝算比為1.270 (95%CI 1.080, 1.494，p=0.004)。換算每ppb將增加罹病9%/ppb，比此處南高屏地區之常態化發生率之斜率平均值2.9%/ppb還高，然尚屬同一數量級。
