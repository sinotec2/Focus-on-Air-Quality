...
- 高空點源的**時變係數**檔案需按CEMS數據先行[展開](/Focus-on-Air-Quality/EmisProc/ptse/ptseE_ONS/)。
...
### [ptse_sub](/Focus-on-Air-Quality/EmisProc/ptse/ptse_sub/)
...
- 調用模組
  - 因無另存處理過後的資料庫，因此程式還是會用到[ptse_sub](/Focus-on-Air-Quality/EmisProc/ptse/ptse_sub/)中的副程式`CORRECT`, `add_PMS`, `check_nan`, `check_landsea`, `FillNan`, `WGS_TWD`, `Elev_YPM`
...
```
- PM的劃分，詳見[ptse_sub](/Focus-on-Air-Quality/EmisProc/ptse/ptse_sub/#%E7%B0%A1%E5%96%AE%E7%9A%84pm%E5%8A%83%E5%88%86%E5%89%AF%E7%A8%8B%E5%BC%8F)
