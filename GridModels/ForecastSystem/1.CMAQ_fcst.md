...
- 2022-10-05 PM<sub>10</sub>事件模式嚴重低估。經檢討應為公版模式不建議開啟風吹砂機制所造成。經開啟後重新模擬，就可以得到較為合理的[結果](https://github.com/sinotec2/Focus-on-Air-Quality/raw/main/assets/images/PMT_SS.gif)。
...
[fcst.cs]: <https://sinotec2.github.io/Focus-on-Air-Quality/GridModels/ForecastSystem/99.fcst.cs/> "逐日WRF及CMAQ執行腳本 "
...
[run_mcip]: <https://sinotec2.github.io/Focus-on-Air-Quality/GridModels/ForecastSystem/99.fcst.cs/> "逐日mcip之執行腳本"
